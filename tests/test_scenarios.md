...
*Real situations people might actually report*

I put together these test cases based on stuff I've seen in real incident reports. They're written how normal employees would describe problems - no fancy security terminology.

## Scenario 1: Login Issues
**What someone might say:** "I got an email saying someone tried to log into my account from Russia 15 times last night. I've been using the same password for like 3 years."

*Should classify as:* Brute force attack
*Why it's good for testing:* Has geographic clues, password security implications
